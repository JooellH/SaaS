...
const base =
  "inline-flex items-center justify-center gap-2 rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/70 h-11";
...
const variants: Record<ButtonVariant, string> = {
  ...
  brand:
    "bg-[linear-gradient(90deg,var(--brand-color,#7c3aed),var(--brand-color,#7c3aed))] px-4 py-2 text-white shadow-lg shadow-indigo-500/20 hover:translate-y-[-1px] hover:shadow-xl hover:shadow-indigo-500/25 active:translate-y-0 disabled:opacity-60 disabled:cursor-not-allowed",
};
